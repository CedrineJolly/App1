...
document.getElementById('submitEnfant').addEventListener('click', async (evt) => {
    ...
    try {
        ...
        //Mise à jour de l'état du contrat pour qu'il apparaisse
        window.bridge.updateEtatContrat(enfantContrat.IdEnfant, 1);
        console.log('Le contrat est validé et en cours.');
    }
    catch (error) {
        console.error(error);
    }
...
/* Code pour valider avec un fenêtre de téléchargement 
            ...
            <body id="page-top">
                ...
                <section>
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <script src="../renderers/enregistrer.js" type="module"></script>
                        <div class="d-grid">
                            <button class="btn btn-primary btn-lg mt-4 mb-3" id="saveEnfant" type="submit">Enregistrer</button>
                        </div>
                    </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="d-grid">
                        <button class="btn btn-dark btn-lg mt-4 mb-3" id="archiveEnfant" type="submit">Archiver</button>
                    </div>
                    <script src="../renderers/archiveenfant.js" type="module"></script>
                </section>
                </div>
                </div>
